  ...
  return (
    <div
      className="
        ...
        [&>h2]:font-display [&>h2]:text-2xl [&>h2]:font-semibold [&>h2]:text-foreground [&>h2]:mt-12 [&>h2]:mb-3 sm:[&>h2]:text-3xl
        ...
        [&>blockquote]:mt-6 [&>blockquote]:border-l-4 [&>blockquote]:border-gold-400 [&>blockquote]:bg-cream-100 [&>blockquote]:py-2 [&>blockquote]:pl-5 [&>blockquote]:text-foreground/70 [&>blockquote]:italic
