  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        longDescription:
          "Silver adds up faster than most people expect, and we make selling it straightforward. We buy sterling silver jewelry and flatware, silver bullion bars and rounds, and pre-1965 US 90% silver coins, paying a fair, transparent price based on weight, purity, and the live silver spot price. Sterling is stamped .925, and we test and weigh every item in front of you so you can see exactly how the offer is reached. There is no minimum, no appraisal fee, and no obligation to sell, whether you bring a single tea set, a drawer of flatware, or a box of bullion and junk silver. Because silver trades at a lower price per ounce than gold, quantity matters, and we welcome large lots as readily as single pieces. As a local silver buyer with four Northern Virginia stores, we pay instant cash the same visit and let you keep your silver until you accept. Bring your sterling, bullion, or coins to our Annandale, Manassas, Chantilly, or Vienna/McLean location for a free, no-pressure appraisal.",
        gallery: [
